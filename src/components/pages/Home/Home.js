            ...
            <div className="row">
              ...
              <div className="col-12 col-md-6">
                ...
                <div className="row">
                  ...
                  <div className="col-12 col-md-6  my-5 text-center hvr-bob">
                    <i className="fas fa-file fa-3x"></i><a className="button" href="https://drive.google.com/file/d/1htKLkx0y-RllRZFXIWDnP1IzZ7jaUz2N/view?usp=sharing" rel="noreferrer noopener" target="_blank"><h4>Resume</h4></a>
                  </div>
